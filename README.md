...
- `okaso-bukkit/target/okaso-bukkit-1.6.1.jar` — for Bukkit/Spigot/Paper servers
- `okaso-bungeecord/target/okaso-bungeecord-1.6.1.jar` — for BungeeCord proxies
- `okaso-velocity/target/okaso-velocity-1.6.1.jar` — for Velocity proxies
- `okaso-waterfall/target/okaso-waterfall-1.6.1.jar` — for Waterfall proxies
