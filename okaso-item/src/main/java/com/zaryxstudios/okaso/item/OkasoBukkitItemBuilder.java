...
public class OkasoBukkitItemBuilder implements ItemBuilder {
    ...
    private OkasoBukkitItemBuilder(ItemStack itemStack) {
    ...
    public OkasoBukkitItemBuilder(Material material) {
        this(material, 1);
    }

    public static OkasoBukkitItemBuilder of(Material material) {
        return new OkasoBukkitItemBuilder(material);
    }
    ...
    public OkasoBukkitItemBuilder placeholders(Map<String, ?> values) {
    ...
    public ItemBuilder name(String name) {
        if (meta != null && name != null) {
            meta.setDisplayName(ChatColor.translateAlternateColorCodes('&', applyPlaceholders(name)));
        }
        return this;
    }
    ...
    public ItemBuilder addLoreLine(String line) {
        ...
        lore.add(ChatColor.translateAlternateColorCodes('&', applyPlaceholders(line)));
        meta.setLore(lore);
        return this;
    }
    ...
    public ItemBuilder setLoreLine(int index, String line) {
        ...
        if (lore != null && index >= 0 && index < lore.size()) {
            lore.set(index, ChatColor.translateAlternateColorCodes('&', applyPlaceholders(line)));
            meta.setLore(lore);
        }
        return this;
    }
    ...
    public ItemBuilder insertLoreLine(int index, String line) {
        ...
        if (index >= 0 && index <= lore.size()) {
            lore.add(index, ChatColor.translateAlternateColorCodes('&', applyPlaceholders(line)));
            meta.setLore(lore);
        }
        return this;
    }
